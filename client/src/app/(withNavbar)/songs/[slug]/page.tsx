                ...
                <div className="w-full max-w-3xl">
                    ...
                    <div className="flex justify-end my-5 w-[43rem]">
                        <Link href={`/songs/${song.slug}/course`}
                            className="bg-yellow-400 hover:bg-yellow-500 mr-4 text-black font-bold py-2 px-4 rounded transition duration-300 ease-in-out transform hover:scale-105 active:scale-95"
                        >
