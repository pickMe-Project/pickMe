    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-200">
            <div className="w-full max-w-md p-10 space-y-8 bg-white rounded-xl shadow-2xl">
                <h1 className="text-4xl font-bold text-center text-black font-libre">Sign In</h1>
                <form className="mt-10 space-y-6 font-cousine">
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            <input id="password" name="password" type="password" required className="w-full px-4 py-2 text-black bg-transparent border-b-2 border-gray-300 focus:outline-none focus:border-black transition duration-300 peer" placeholder=" " />
                ...
                <div className="text-center text-sm text-gray-600 mt-4 font-dmsans">
                    <Link href="#" className="hover:text-black transition duration-300">Forgot password?</Link>
                    <span className="mx-2">•</span>
                    <Link href="/register" className="hover:text-black transition duration-300">Sign up</Link>
                    <span className="mx-2">•</span>
                    <Link href="/" className="hover:text-black transition duration-300">Continue as guest</Link>
                </div>
            </div>
        </div>
    )
